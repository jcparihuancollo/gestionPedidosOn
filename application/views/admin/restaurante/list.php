    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url();?>mantenimiento/restaurantes/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar Restaurante</a>
                    </div>
                </div>
                <hr>
                <div class="row">
                                ...
                                <?php if(!empty($restaurantes)):?>
                                    <?php foreach($restaurantes as $restaurante):?>
                                        <tr>
                                            ...
                                            <td><?php echo $restaurante->celular;?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Informacion del Restaurante</h4>
      </div>
